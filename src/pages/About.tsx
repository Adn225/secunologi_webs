    ...
    <div className="min-h-screen bg-gray-50 pt-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              ...
              <div key={index} className="text-center">
                <div className="bg-olive-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <value.icon className="h-8 w-8 text-olive-700" />
                </div>
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          {[
            ...
            <div key={index} className="text-center bg-white p-6 rounded-lg shadow">
              <div className="text-3xl font-bold text-olive-700 mb-2">{stat.number}</div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          <div className="bg-olive-700 text-white p-8 rounded-lg">
        ...
        <section className="bg-gray-100 rounded-lg p-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex items-center justify-center">
              <MapPin className="h-6 w-6 text-olive-700 mr-3" />
              <div>
            ...
            <div className="flex items-center justify-center">
              <Clock className="h-6 w-6 text-olive-700 mr-3" />
              <div>
