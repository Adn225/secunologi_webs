          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex border border-gray-300 rounded-lg overflow-hidden">
              <button
                ...
                className={`p-2 ${viewMode === 'grid' ? 'bg-olive-700 text-white' : 'bg-white text-gray-600'}`}
              >
                <Grid className="h-4 w-4" />
              </button>
              <button
                onClick={() => setViewMode('list')}
                className={`p-2 ${viewMode === 'list' ? 'bg-olive-700 text-white' : 'bg-white text-gray-600'}`}
              >
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="mb-6">
                ...
                <select
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-olive-500 focus:border-transparent"
                >
              ...
              <button
                ...
                className="w-full text-olive-700 hover:text-olive-800 font-medium"
              >
